function [meanDistance, mergeGroups, mergeDistances, nonMergeDistances, T_electrode_DTW] = template_comparison_dtwfigures(DTW_figure, electrode_DTW_folder,i,j,m,n,Times,waveforms, clusterIndices, mergeThreshold,overlap_threshold)
...
%   T_electrode_DTW - Table with DTW distances and unit statistics
    ...
    for template1_idx = 1:templateCount-1
        for template2_idx = template1_idx+1:templateCount
            ...
            shapeSimilarityThreshold = 1-overlap_threshold;
            ...
            subplot(2,1,1, 'Parent',DTW_figure);
            hold on;
            ...
            subplot(2,1,2, 'Parent',DTW_figure);
            axis off;
            ...
            % Save figure
            saveas(DTW_figure,[electrode_DTW_folder,var_name_unit],'png');
