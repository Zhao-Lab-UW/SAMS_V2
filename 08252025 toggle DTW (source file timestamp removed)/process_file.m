        ...
        for j = 1:nwc
            ...
            for m = 1:nec
                for n = 1:ner
                    ...
                    if params.DTWfigure_check % if user decide to output DTW figure
                        DTW_figure = figure('visible','off', 'Position', [100, 100, 800, 600]);
                    else
                        DTW_figure = 'None';
                    end
                    % Process electrode
                    try
                        [electrode_results, electrode_stats] = process_electrode(logFile, spikes, Times, i, j, m, n, ...
                            params, maxTime, maxSpikeAmp, minSpikeAmp, score, electrode_DTW_folder, DTW_figure);
                    catch ME
