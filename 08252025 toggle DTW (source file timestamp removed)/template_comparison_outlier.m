function [mergedOutlierList, unsortedWaveformClusters] = template_comparison_outlier(waveforms, templateClusters, outlierIndices, clusterFunction, kValues, pcaScores, stdCutoff, overlap_threshold)
...
%   unsortedWaveformClusters - Cell array of new clusters from remaining outliers
    ...
    for outlierIndex = 1:length(outlierIndices)
        ...
        for templateIndex = 1:clusterCount
            ...
            shapeThreshold = 1-overlap_threshold;
